...
// Snapshot Testing: takes a snapshot of the file/component in question and in future tests compares if the component/file is EXACTLY the same or if ANYTHING changed = error...
